package np.com.debid.restroproductservice.constant;

public class Constant {
    public static class Messages {
        public static final String PRODUCT_CREATED = "Product created successfully.";
        public static final String PRODUCT_NOT_FOUND = "Error: Product is not found.";
    ...
    public static class ErrorCodes {
        public static final int PRODUCT_NOT_FOUND_ERROR_CODE = 4003;
    }
}