...
public class CategoryController {
    ...
    @PostMapping("/create")
    public ResponseEntity<ResponseWrapper<Category>> createCategory(@Valid @RequestBody CategoryRequest categoryRequest) {
        return ResponseUtil.successResponse(CATEGORY_CREATED, categoryService.createCategory(categoryRequest));
    }
    ...
    public ResponseEntity<ResponseWrapper<List<CategoryResponse>>> getAllCategoriesByRestaurant() {
        return ResponseUtil.successResponse(CATEGORIES_FETCHED, categoryService.getAllCategoriesByRestaurant());
    }
}
