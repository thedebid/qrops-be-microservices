...
import np.com.debid.restroauthservice.dto.UserResponse;
import np.com.debid.restroauthservice.entity.Role;
import np.com.debid.restroauthservice.entity.User;
import np.com.debid.restroauthservice.entity.UserDTO;
import np.com.debid.restroauthservice.repository.RoleRepository;
import np.com.debid.restroauthservice.repository.UserRepository;
...
import static np.com.debid.restroauthservice.constant.Constant.ErrorCodes.EMAIL_IS_ALREADY_TAKEN_ERROR_CODE;
import static np.com.debid.restroauthservice.constant.Constant.ErrorCodes.ROLE_NOT_FOUND_ERROR_CODE;
import static np.com.debid.restroauthservice.constant.Constant.ErrorCodes.USERNAME_IS_ALREADY_TAKEN_ERROR_CODE;
import static np.com.debid.restroauthservice.constant.Constant.Messages.EMAIL_IS_ALREADY_TAKEN;
import static np.com.debid.restroauthservice.constant.Constant.Messages.ROLE_NOT_FOUND;
import static np.com.debid.restroauthservice.constant.Constant.Messages.USERNAME_IS_ALREADY_TAKEN;
